...
<body>
    <form name="form1" method="post" action="filedownload.aspx?FileId=815490" id="form1">
<div>
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODAxMzY1NzQ2D2QWAgIDD2QWBAIDDw8WAh4HVmlzaWJsZWhkZAIFDw8WAh8AaGRkZALAr1adkjtFY/00QWZq/Nts+jfG" />
</div>

<div>

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="72BA71D8" />
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAwLp5/b3AgK5wrnPBQLU1smIAneV6YG195BPMNqLbZn5emtFjDry" />
</div>
    ...
    <table>
        ...
        <tr>
            <td colspan="2">
                <input type="hidden" name="hdnFilename" id="hdnFilename" value="scala_practice.java" />
